This is the "testers table" with the phones we're currently testing on and which one of us is using it. Table columns are: Phone Model, Application Processor & Baseband Processor, FW ROM, AOS, API Version, *SELinux* Mode, Developer Name
